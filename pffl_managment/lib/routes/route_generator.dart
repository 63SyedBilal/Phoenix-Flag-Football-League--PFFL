...
import 'package:pffl_managment/features/admin/matches/widgets/edit_upcomming_matches.dart';
...
import 'package:pffl_managment/features/admin/matches/views/games_view.dart';
import 'package:pffl_managment/features/admin/models/leagues_models/league_creation_model.dart';
import 'package:pffl_managment/features/admin/settings/widgets/payment_receipt_screen.dart';
import 'package:pffl_managment/features/captain/view/home/home_screen.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.captainPaymentHistory:
        return MaterialPageRoute(builder: (_) => const CaptainPaymentHistoryView());
      ...
      //   print('Route adminCreateMatch called');
      //   return MaterialPageRoute(builder: (_) => const CreateMatchView());
