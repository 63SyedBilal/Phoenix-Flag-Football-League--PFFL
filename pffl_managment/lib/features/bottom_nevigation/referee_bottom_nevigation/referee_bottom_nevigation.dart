...
class RefereeBottomNevigation extends StatelessWidget {
  const RefereeBottomNevigation({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<RefereeNavigationProvider>(
          ...
          child: SafeArea(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  NavItem(
                    svgIcon: SvgIcons.homeunselected(size: 20),
