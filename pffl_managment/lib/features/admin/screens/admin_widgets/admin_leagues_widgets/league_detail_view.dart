...
import 'package:pffl_managment/features/admin/screens/admin_widgets/admin_leagues_widgets/animated_gab.dart';
...
import 'package:pffl_managment/features/admin/screens/admin_widgets/admin_leagues_widgets/league_upcoming_matches_section.dart';
            ...
            child: Column(
              children: [
                LeagueDetailHeader(
                  ...
                  subtitle:
                      'Stay updated with all details, Games, and stats for this league.',
                    ...
                    child: Column(
                      children: [
                        if (provider.selectedTabIndex == 0) ...[
                          const LeagueUpcomingMatchesSection(),
                          SponsorBannerScreen(),
