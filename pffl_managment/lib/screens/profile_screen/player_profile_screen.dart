...
import 'package:pffl_managment/screens/profile_screen/provider/player_profile_provider.dart';
...
class PlayerProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => PlayerProfileProvider(prefs)..initialize(),
      child: _PlayerProfileContent(theme: theme),
    );
  }
}
...
class _PlayerProfileContent extends StatelessWidget {
  ...
  const _PlayerProfileContent({required this.theme});

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<PlayerProfileProvider>(context);
  ...
  Widget _buildAvatar(PlayerProfileProvider provider) {
