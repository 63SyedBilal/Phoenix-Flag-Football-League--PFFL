...
import 'package:pffl_managment/screens/profile_screen/provider/referee_profile_provider.dart';
...
class RefereeProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => RefereeProfileProvider(prefs)..initialize(),
      child: _RefereeProfileContent(theme: theme),
    );
  }
}

class _RefereeProfileContent extends StatelessWidget {
  final ThemeData theme;

  const _RefereeProfileContent({required this.theme});

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<RefereeProfileProvider>(context);
  ...
  Widget _buildAvatar(RefereeProfileProvider provider) {
