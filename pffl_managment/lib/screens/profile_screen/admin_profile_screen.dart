...
import 'package:pffl_managment/screens/profile_screen/provider/admin_profile_provider.dart';
...
class AdminProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => AdminProfileProvider(prefs)..initialize(),
      child: _AdminProfileContent(theme: theme),
    );
  }
}
...
class _AdminProfileContent extends StatelessWidget {
  ...
  const _AdminProfileContent({required this.theme});
