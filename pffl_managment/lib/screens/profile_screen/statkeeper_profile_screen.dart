...
import 'package:pffl_managment/screens/profile_screen/provider/statkeeper_profile_provider.dart';

class StatkeeperProfileScreen extends StatelessWidget {
  const StatkeeperProfileScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => StatkeeperProfileProvider(prefs)..initialize(),
      child: _StatkeeperProfileContent(theme: theme),
    );
  }
}

class _StatkeeperProfileContent extends StatelessWidget {
  final ThemeData theme;

  const _StatkeeperProfileContent({required this.theme});

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<StatkeeperProfileProvider>(context);
  ...
  Widget _buildAvatar(StatkeeperProfileProvider provider) {
