...
export default function CaptainPage() {
  ...
  const [activeFilter, setActiveFilter] = useState("Captains")
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-3xl font-bold text-foreground">Captains</h1>
        <p className="text-muted-foreground mt-1">Manage all captains.</p>
      </div>
